...
import com.chaohu.service.serviceTea.client.OrdersClient;
...
@RestController
@RequestMapping("/serviceTea/eduservice/coursefront")
@CrossOrigin
public class CourseFrontController {
    ...
    public R getFrontCourseInfo(@PathVariable String courseId, HttpServletRequest request) {
        ...
        //根据课程id查询章节和小节
        List<ChapterVo> chapterVideoList = chapterService.selectChapterAndVideo(courseId);
